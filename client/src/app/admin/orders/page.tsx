...
//     setLoading(true);
//     try {
//       const res = await fetch('/api/admin/orders'); // Calls our new Backend API
...
//       {/* 1. TOP CARDS (Live Counts) */}
//       <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
//         <DashboardCard title="TOTAL ORDERS" count={data?.totalOrders || 0} color="bg-white border-gray-200" icon={<ShoppingBag size={20} className="text-gray-500" />} />
//         <DashboardCard title="NEW" count={data?.newOrders || 0} color="bg-blue-50 border-blue-100 text-blue-700" icon={<Clock size={20} />} />
//         <DashboardCard title="ACTIVE" count={data?.activeOrders || 0} color="bg-purple-50 border-purple-100 text-purple-700" icon={<Truck size={20} />} />
//         <DashboardCard title="DELIVERED" count={data?.deliveredOrders || 0} color="bg-green-50 border-green-100 text-green-700" icon={<CheckCircle size={20} />} />
//         <DashboardCard title="REJECTED" count={data?.rejectedOrders || 0} color="bg-red-50 border-red-100 text-red-700" icon={<XCircle size={20} />} />
//       </div>
...
// const DashboardCard = ({ title, count, color, icon }: any) => (
//   <div className={`p-4 rounded-xl border ${color} shadow-sm flex flex-col justify-between h-24`}>
